...
subtitle: Just 2 additional files. A manifest and a service worker JavaScript, both
  less than 10 lines. That's all it takes to install your website to your mobile home
  screen.
date: 2018-09-06 21:15:59 +0530
tags:
- Service Workers
- Javascript
- PWA
...
---
Creating a web page is surprisingly easy. All you need is a single HTML file. But converting it to a [Progressive Web App](/post/progressive-web-apps-reclaim-users-all-you-need-to-know/) that you can install is perceived as a complex business. In reality, it is shockingly easier. You need two more files, with less than 10 lines each.
...
You can reuse the png from the [pwa-features](https://github.com/vijayabharathib/pwa-features/tree/master/10.manifest) repository. Or you can create your own. Either way, create a folder named `images` and place two place two `png` images with appropriate size.
...
So far, we've used only the `localhost` development environment. To go online, we can use GitHub itself. It is very easy to switch on [Github Pages](https://pages.github.com/) for this repository and install this app from internet.
